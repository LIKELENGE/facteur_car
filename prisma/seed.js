...
async function main() {
  ...
  // Dégâts
  // Maintenant un dégât appartient à une conduite via idConduire.
  // Une conduite peut donc avoir plusieurs dégâts.
  await prisma.degat.createMany({
    data: [
      ...
      },
      {
        ...
        dateConstat: new Date('2025-01-12T10:15:00'),
      ...
      {
        idDegat: 5,
        description: 'Feu arrière droit fissuré',
        dateConstat: new Date('2025-02-18T12:20:00'),
        lienImage: 'images/degats/feu-arriere-droit.jpg',
        idConduire: 4,
      },
    ],
  });
